  ...
  public void onMessage(MessageReceivedEvent event) {
    if (main.isReady()) {
      ...
      if (message.split(" ")[0].equalsIgnoreCase(main.getSymbol() + "help")) {
        DankUtils.sendMessage(help, user.getOrCreatePMChannel());
      }
      ...
      // Info
        ...
        DankUtils.sendMessage(user.mention() + " " + main.getMusicScheduler().getTrackInfo(),
      ...
      if (url != null) {
        if (DankUtils.getConnectedChannel(main.getGuild(), user) != null) {
